...
public class StatementsTest {
    ...
    @Test
    public void testGetSelectTaskCountFromTaskDefLimitStatement() {
        String statement = "SELECT count(*) FROM junit.task_def_limit WHERE task_def_name=?;";
        assertEquals(statement, statements.getSelectTaskCountFromTaskDefLimitStatement());
    }
    ...
    public void testGetUpdateTaskDefLimitStatement() {
        String statement = "UPDATE junit.task_def_limit SET task_id_value=? WHERE task_def_name=? AND task_id=?;";
